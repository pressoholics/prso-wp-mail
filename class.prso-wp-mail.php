...
class PrsoWpMail {
	...
	protected $plugin_ajax_nonce				= 'prso_wp_mail-ajax-nonce';
	protected $plugin_path						= PRSOWPMAIL__PLUGIN_DIR;
	protected $plugin_url						= PRSOWPMAIL__PLUGIN_URL;
	protected $plugin_textdomain				= PRSOWPMAIL__DOMAIN;
	...
	function __construct( $config = array() ) {
		...
		//Init plugin
		add_action( 'muplugins_loaded', array($this, 'init_mu_plugin') );
	...
	* init_mu_plugin
	* 
	* Used By Action: 'muplugins_loaded'
	* 
	*
	* @access 	public
	* @author	Ben Moody
	*/
	public function init_mu_plugin() {
		...
		include_once( $this->plugin_path . 'core.prso-wp-mail.php' );
